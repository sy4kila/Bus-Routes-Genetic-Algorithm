...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line_gen.setToolTip("Insert integer number!.")
        input_validator = QtGui.QRegularExpressionValidator(reg_ex, self.line_gen)
        ...
        self.line_pop.setToolTip("Insert integer number!.")
        input_validator = QtGui.QRegularExpressionValidator(reg_ex, self.line_pop)
        ...
        self.line_route.setToolTip("Insert integer number!.")
        input_validator = QtGui.QRegularExpressionValidator(reg_ex, self.line_route)
        ...
        self.line_mut.setToolTip("Insert integer number!.")
        input_validator = QtGui.QRegularExpressionValidator(reg_ex, self.line_mut)
        ...
        self.line_copy.setToolTip("Insert integer number!.")
        input_validator = QtGui.QRegularExpressionValidator(reg_ex, self.line_copy)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Genetic Algorithm for Bus Routes"))
    ...
    def model_start(self):
        ...
        self.lab_demand.setText(_translate("MainWindow", "% Demand Fulfilled " + f"{demand_fit}"))
